...
def gi_registry():
    """Nigerian GI Registry - temporarily disabled"""
    flash('GI Registry feature is coming soon!', 'info')
    return redirect(url_for('marketplace'))


@app.route('/gi/search')
def gi_search():
    """Search GI products - temporarily disabled"""
    flash('GI Registry feature is coming soon!', 'info')
    return redirect(url_for('marketplace'))
...
def admin_gi_dashboard():
    """Admin GI management dashboard - temporarily disabled"""
    flash('GI Management feature is coming soon!', 'info')
    return redirect(url_for('admin_dashboard'))
...
def manage_gi_claim(produce_id):
    """Manage individual GI claim - temporarily disabled"""
    flash('GI Management feature is coming soon!', 'info')
    return redirect(url_for('admin_dashboard'))
...
# Cross-Border Trade Routes - TEMPORARILY DISABLED
@app.route('/export')
@login_required
...
def create_export_listing():
    """Create new export listing - temporarily disabled"""
    flash('Cross-border export trade feature is coming soon!', 'info')
    return redirect(url_for('marketplace'))
...
def my_export_listings():
    """View user's export listings - temporarily disabled"""
    flash('Cross-border export trade feature is coming soon!', 'info')
    return redirect(url_for('farmer_dashboard'))
...
def export_listing_detail(listing_id):
    """View detailed export listing - temporarily disabled"""
    flash('Cross-border export trade feature is coming soon!', 'info')
    return redirect(url_for('marketplace'))
...
def admin_export_management():
    """Admin export management - temporarily disabled"""
    flash('Export management feature is coming soon!', 'info')
    return redirect(url_for('admin_dashboard'))
...
def update_export_status(listing_id):
    """Update export status - temporarily disabled"""
    flash('Export management feature is coming soon!', 'info')
    return redirect(url_for('admin_dashboard'))
...
def download_certificate(listing_id):
    """Download certificate - temporarily disabled"""
    flash('Export trade feature is coming soon!', 'info')
    return redirect(url_for('marketplace'))
